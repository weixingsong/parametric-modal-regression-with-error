...
#Naive Numerical summary of beta and phi
 ...
 NBtnumsum=rbind(NBtS)
 dimnames(NBtnumsum)=list(c("Stdev"),
...
#Naive Numerical summary of beta and phi  "sd"
 ...
 NSdnumsum=rbind(NSdM,NSdS)
 dimnames(NSdnumsum)=list(c("Mean",
                         "Stdev"),
                       c("beta0","beta1","beta2","beta3","phi"))
...
# Numerical summary of beta and phi
 ...
 Btnumsum=rbind(BtS)
 dimnames(Btnumsum)=list(c("Stdev"),
                       c("beta0","beta1","beta2","beta3","phi"))
 ...
 Sdnumsum=rbind(SdM,SdS)
 dimnames(Sdnumsum)=list(c("Mean",
                         "Stdev"),
                       c("beta0","beta1","beta2","beta3","phi"))
...
te=Sys.time()
time=te-ts
save(file="Table B.12.RData",list=ls())
