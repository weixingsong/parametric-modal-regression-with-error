...
scatter3D(x1, x2, y, pch = 19, cex = 2, colvar = NULL, col = "black",
    theta = 15, phi = 20, ticktype = "detailed",
    xlab = "Intake1", ylab = "Intake2", zlab = "FFQ",  
    surf = list(x = x1.pred, y = x2.pred, z = z1.pred,  
    facets = NA,
    col="gray56"), main = "Modal Regression of FFQ vs. Long Time Intake",zlim=c(zlow,zup))
...
scatter3D(x1, x2, y, pch = 19, cex = 2, colvar = NULL, col = "black",
    ...
    facets = NA,
    col="gray56"
    ), main = "Modal Regression of FFQ vs. Long Time Intake",zlim=c(zlow,zup),add=TRUE)
plotrgl()
