...
# Test methods: Cramer von-Mise, and Kolmogrov-Smirnov    
 ...
 rm(list=ls())
 packages = c("MASS", "smoothmest","pracma","VGAM","gofgamma",  "VGAM")
...
#  Model Setup
 ...
 plot(pvseq,p1,type="l",col="blue",lwd=2,xlim=c(0.01,0.5),ylim=c(ymini,ymaxi),main="n=100.KS",xlab="Significance Level",ylab="Rejection Rate")
...
save(file="n=100.ks0.5M4.RData",list=ls())