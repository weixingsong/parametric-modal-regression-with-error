...
# Test methods: Cramer von-Mise, and Kolmogrov-Smirnov    
 ...
 rm(list=ls())
 packages = c("MASS", "smoothmest","gofgamma")
...
#  Model Setup
 ...
 plot(pvseq,p1,type="l",col="blue",lwd=2,xlim=c(0.01,0.5),ylim=c(ymini,ymaxi),main="n=200.KS",xlab="Significance Level",ylab="Rejection Rate")
...
save(file="n=200.ksM5.RData",list=ls())