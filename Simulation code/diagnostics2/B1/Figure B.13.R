...
#plot(pv,fp1,type="l",main="n=100.Kernel",xlab="Significance Level",ylab="Rejection Rate")
#lines(pv,fp2)
#lines(pv,pv,lty=2,lwd=2)

plot(pv,fp1,type="l",xlab="Nominal Significance Level (n=100)",ylab="Rejection Rate")
lines(pv,fp2)
lines(pv,pv,lty=3)

 te=Sys.time()
time=te-ts
save(file="n=100.kerM1.RData",list=ls())
