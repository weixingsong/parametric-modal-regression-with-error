...
#  Model Setup
 ...
 plot(pvseq,p1,type="l",xlim=c(0.01,0.5),ylim=c(ymini,ymaxi),xlab="Nominal Significance Level (n=100)",ylab="Rejection Rate")
...
save(file="Figure B.17 n=100.RData",list=ls())
